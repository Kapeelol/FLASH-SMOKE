...
- **แผนที่จริง** (Leaflet + OpenStreetMap/CARTO — ฟรี ไม่ต้องมี API key/บัตรเครดิต) แทนที่แผนที่จำลองเดิม: แตะ/ลากหมุดบนแผนที่จริง แล้วระบบค้นหาที่อยู่จริงให้อัตโนมัติ (reverse geocoding ผ่าน Nominatim), ปุ่ม "ใช้ตำแหน่งปัจจุบัน" ใช้ GPS จริงของเบราว์เซอร์, หน้ารายละเอียดออเดอร์ของแอดมินก็โชว์แผนที่จริงพร้อมพิกัดแม่นยำ (~1 เมตร) ของจุดที่ลูกค้าปักหมุดมา
- **สถานที่สำคัญบนแผนที่** — โชว์ร้านอาหาร/คาเฟ่/ร้านเหล้า/ร้านสะดวกซื้อจริงรอบ ๆ (ดึงจาก OpenStreetMap Overpass API ฟรี) เป็นหมุดเล็กมีอิโมจิ แตะดูชื่อร้านได้ อัปเดตอัตโนมัติเมื่อเลื่อนแผนที่
- **ป๊อปอัพโฆษณา — ปุ่ม "ไม่แสดงอีกในวันนี้"** — ลูกค้ากดแล้วโฆษณาจะไม่เด้งอีกจนกว่าจะขึ้นวันใหม่ (จำไว้ในเครื่องของลูกค้า)
